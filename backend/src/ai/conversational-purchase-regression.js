...
const cases = [
  ...
  ['Queria comprar um celular.', 'purchase'],
  ['Tô pensando em comprar um celular.', 'purchase'],
  ['Estou pensando em pegar um celular.', 'purchase'],
  ['Tô querendo trocar de celular.', 'purchase'],
  ['Queria pegar um notebook novo.', 'purchase'],
  ['Estou de olho num celular.', 'purchase'],
  ['Tô de olho em uma TV.', 'purchase'],
  ['Achei um celular por 1300.', 'purchase'],
  ['Vi um notebook por R$ 2.500.', 'purchase'],
  ['Será que dá pra comprar um celular?', 'purchase'],
  ['Será que eu consigo comprar um celular?', 'purchase'],
  ['Dá pra eu comprar esse celular?', 'purchase'],
  ['Vale a pena pegar esse celular?', 'purchase'],
  ['Vou pegar um celular novo.', 'purchase'],
  ['Quero pegar um notebook.', 'purchase'],
  ['Quero trocar meu celular.', 'purchase'],
  ['Tô querendo pegar uma TV.', 'purchase'],
  ['Vou fazer em 7 vezes.', 'purchase'],
  ['Vou pegar em 5 parcelas.', 'purchase'],
  ['Fica 7 parcelas de 185.', 'purchase'],
  ['E se eu parcelar?', 'purchase']
];
...
const followUps = [
  ...
  ['E se eu parcelar?', 'purchase'],
  ['Quanto fica por mês?', 'purchase'],
  ['Essa compra cabe?', 'purchase'],
  ['E se eu fizer em 7 vezes?', 'purchase']
];
