...
assert.equal(detectIntent('qual foi meu salário em janeiro de 2025'),'historical_income');assert.equal(detectIntent('posso comprar um celular de 1200'),'purchase');assert.equal(detectIntent('faça um diagnóstico completo'),'diagnosis');
...
console.log('P360 AI v3 self-test: OK');
