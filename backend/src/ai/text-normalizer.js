const REPLACEMENTS = [
  ...
  [/\bpretendo\b/g, 'pretendo'], [/\bobjtivo\b/g, 'objetivo'], [/\bmetaa\b/g, 'meta'],
  ...
  [/\borcamentoo\b/g, 'orcamento'], [/\bmesn?al\b/g, 'mensal'], [/\bfinancas\b/g, 'financas'],
  [/\bdisponivel\b/g, 'disponivel'], [/\bdisponivel\b/g, 'disponivel'], [/\bparcelas?\b/g, 'parcelas']
];
