...
export function extractMemoryFromMessage(message, assistantAnswer='') {
  ...
  if (/voce interpretou errado|você interpretou errado|est[aá] errado|quis dizer|corrigindo|nao foi isso|não foi isso/.test(q)) corrections.push({key:id('correction'),message,createdAt:new Date().toISOString()});
